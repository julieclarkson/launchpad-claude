...
description: "General framework for pulling assets from MCP connectors (Figma, Linear, Notion, etc.) into the case study. Use when the user says 'pull from Linear', 'add Notion docs', 'import from [tool]', or 'connect [tool] to case study'."
---

# Integrate Assets

Pull data and assets from MCP connectors into the case study timeline.

## Supported integrations

This skill works with any MCP connector that provides tools. Common integrations:

| Connector | What to pull | MCP tool |
|---|---|---|
...
5. If the connector isn't installed, explain what's needed and offer manual alternatives.
...
If a connector isn't installed, always offer manual alternatives:
- Screenshots: save images to `.case-study/media/`
- Context: use `/case-study-maker:capture` to manually document the information
