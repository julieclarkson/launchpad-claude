...
**MANDATORY:** Run the selection flow (template, theme) before the skill. Same UX as `/case-study-maker:generate` Steps 2–3. Never skip to defaults — always discover options and present choices.
