...
**MANDATORY:** Run the selection flow (template, theme, style mode) before the skill. Same UX as `/case-study-maker:generate` Steps 2–5. Never skip to defaults — always discover options and present choices.
